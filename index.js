...
async function broadcastToAllUsers(adminChatId, message, photoFileIdOrUrl = null) {
    ...
    for (const userId of userIds) {
        ...
        try {
            ...
            // যদি কোনো ইউজার বট ব্লক করে থাকে বা অন্য কোনো সমস্যা হয়, তবুও ব্রডকাস্ট চলতে থাকবে
...
// 🛑 ফিক্স: /userlist কমান্ডও সবার জন্য চেক করা হবে, তবে কেবল অ্যাডমিনই ব্যবহার করতে পারবে।
// 🆕 নতুন কমান্ড: /userlist
    ...
    let userListMessage = `👤 সকল ইউজারের তথ্য:\n\n`;
    userListMessage += `সর্বমোট ইউজার যারা বট শুরু করেছে: ${totalUsers} জন\n`;
    userListMessage += `অনুমোদিত (Allowed) ইউজার: ${allowedCount} জন\n\n`;
    userListMessage += `(ব্রডকাস্ট এই ${totalUsers} জনের কাছেই যাবে)`;
    
    bot.sendMessage(chatId, userListMessage);
}
...
// ⭐ ব্রডকাস্ট কমান্ড (ছবি সাপোর্টেড) - msg.text চেক ফিক্স করা হয়েছে
...
// নতুন কমান্ড: /allow <chat_id> <time> - msg.text চেক ফিক্স করা হয়েছে
...
// নতুন কমান্ড: /disallow <chat_id> - msg.text চেক ফিক্স করা হয়েছে
...
// নতুন কমান্ড: /uptime - msg.text চেক ফিক্স করা হয়েছে
